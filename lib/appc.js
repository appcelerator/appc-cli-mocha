...
module.exports.log.info.wrap = wrapLogs('info');
module.exports.log.trace.wrap = wrapLogs('trace');
module.exports.log.debug.wrap = wrapLogs('debug');
module.exports.log.error.wrap = wrapLogs('error');
module.exports.log.warn.wrap = wrapLogs('warn');
